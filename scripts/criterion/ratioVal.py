...
@dataclass
class MultiRefRatioValLossConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")

@register_criterion("multi_ref_ratio_val_loss", dataclass=MultiRefRatioValLossConfig)
class MultiRefRatioValLoss(FairseqCriterion):
