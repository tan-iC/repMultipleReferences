...
@dataclass
class MultiRefDiffLossConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")

@register_criterion("multi_ref_diff_loss", dataclass=MultiRefDiffLossConfig)
class MultiRefDiffLoss(FairseqCriterion):
