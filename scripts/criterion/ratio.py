...
@dataclass
class MultiRefRatioLossConfig(FairseqDataclass):
    sentence_avg: bool = II("optimization.sentence_avg")

@register_criterion("multi_ref_ratio_loss", dataclass=MultiRefRatioLossConfig)
class MultiRefRatioLoss(FairseqCriterion):
