...
# ./sh/diffRatioSquaredMaxTuning.sh
###

# method
method="diffRatioSquaredMax"
...
# feature
feature="${method}, ${patience}, ${patience}, dropout=0.0, valid=sentence_pair, vocab_size=32,000"
...
for alpha in "${alphas[@]}" ; do
    ...
    CUDA_VISIBLE_DEVICES=0,1,2 fairseq-train \
        ...
        --criterion multi_ref_diff_ratio_squared_max_loss \
